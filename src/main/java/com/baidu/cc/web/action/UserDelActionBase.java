 ...
 */
@Namespace("/user")
@Results({ @Result(name = "success", location = "/user/listUser.action", type = "redirect")

})
public abstract class UserDelActionBase<ReqParam, DataResult>
        extends
    ...
    /** request param. */
    @FromJSON(validationVisitor = UserDelAction.class)
    protected UserDelActionBase.ReqParam reqParam;
     ...
     * @return ReqParam
     */
    public UserDelActionBase.ReqParam getReqParam() {
        if (reqParam == null) {
            reqParam = new UserDelActionBase.ReqParam();
        }
        return reqParam;
    }
     ...
     *            ReqParam
     */
    public void setReqParam(UserDelActionBase.ReqParam reqParam) {
    ...
    public void setAsDataResult(Object v) {
        if (v instanceof UserDelActionBase.DataResult) {
            setData((UserDelActionBase.DataResult) v);
        }
        setEJsonDataResult(v);
    }

    /** return data object. */
    protected UserDelActionBase.DataResult data;
     ...
     * @return DataResult
     */
    public UserDelActionBase.DataResult getData() {
        if (data == null) {
            data = new UserDelActionBase.DataResult();
        }
        return data;
    }
     ...
     *            DataResult
     */
    protected void setData(UserDelActionBase.DataResult data) {
        this.data = data;
    }
    ...
    protected Object getValidationTarget(Object target) {
        UserDelAction action = new UserDelAction();
        action.setReqParam((UserDelActionBase.ReqParam) target);
        return action;
    }
