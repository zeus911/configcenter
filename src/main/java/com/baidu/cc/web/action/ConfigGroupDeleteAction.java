...
import com.baidu.cc.web.action.ConfigGroupDeleteActionBase.ReqParam;
 ...
 * @author BJF
 */
public class ConfigGroupDeleteAction extends
        ConfigGroupDeleteActionBase<ReqParam, DataResult> {
    ...
    protected DataResult doExecuteService(ReqParam reqParam) {
        ...
        configGroupService.deleteConfigGroupCascadeByIds(SysUtils
                .split2Ids(reqParam.getGroupIds()));
