...
import com.baidu.cc.web.action.ConfigItemBatchInsertActionBase.ReqParam;
 ...
 * @author BJF
 */
public class ConfigItemBatchInsertAction extends
        ConfigItemBatchInsertActionBase<ReqParam, DataResult> {
    ...
    protected DataResult doExecuteService(ReqParam reqParam) {
        configItemService.batchInsertConfigItems(reqParam.getGroupId(),
                reqParam.getVersionId(), reqParam.getContent());
        return null;
    }
