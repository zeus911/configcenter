...
import com.baidu.cc.web.action.ConfigItemSaveActionBase.ReqParam;
 ...
 * @author BJF
 */
public class ConfigItemSaveAction extends
        ConfigItemSaveActionBase<ReqParam, DataResult> {
    ...
    protected DataResult doExecuteService(ReqParam reqParam) {
        configItemService.saveConfigItems(reqParam.getInsertConfigItemList(),
                reqParam.getUpdateConfigItemList(),
                reqParam.getDelConfigItemIds());
        return null;
    }
