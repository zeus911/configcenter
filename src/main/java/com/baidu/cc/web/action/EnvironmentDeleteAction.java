...
import com.baidu.cc.web.action.EnvironmentDeleteActionBase.ReqParam;
 ...
 * @author BJF
 */
public class EnvironmentDeleteAction extends
        EnvironmentDeleteActionBase<ReqParam, DataResult> {
    ...
    protected DataResult doExecuteService(ReqParam reqParam) {
        ...
        idList.add(environmentId);
        environmentService.deleteEnvCascadeByIds(idList);
        return null;
    }
