...
public abstract class PushChangeActionBase<ReqParam, DataResult>
        extends
    ...
    /** request param. */
    @FromJSON(validationVisitor = PushChangeAction.class)
    protected PushChangeActionBase.ReqParam reqParam;
     ...
     * @return ReqParam
     */
    public PushChangeActionBase.ReqParam getReqParam() {
        if (reqParam == null) {
            reqParam = new PushChangeActionBase.ReqParam();
        }
        return reqParam;
    }
     ...
     *            ReqParam
     */
    public void setReqParam(PushChangeActionBase.ReqParam reqParam) {
    ...
    public void setAsDataResult(Object v) {
        if (v instanceof PushChangeActionBase.DataResult) {
            setData((PushChangeActionBase.DataResult) v);
        }
        setEJsonDataResult(v);
    }

    /** return data object. */
    protected PushChangeActionBase.DataResult data;
     ...
     * @return DataResult
     */
    public PushChangeActionBase.DataResult getData() {
        if (data == null) {
            data = new PushChangeActionBase.DataResult();
        }
        return data;
    }
     ...
     *            DataResult
     */
    protected void setData(PushChangeActionBase.DataResult data) {
        this.data = data;
    }
    ...
    protected Object getValidationTarget(Object target) {
        PushChangeAction action = new PushChangeAction();
        action.setReqParam((PushChangeActionBase.ReqParam) target);
        return action;
    }
