...
import com.baidu.cc.web.action.fortest.CheckVersionTagActionBase.ReqParam;
 ...
 * @author BJF
 */
public class CheckVersionTagAction extends
        CheckVersionTagActionBase<ReqParam, DataResult> {
    ...
    protected DataResult doExecuteService(ReqParam reqParam) {
        boolean result = configServerService.checkVersionTag(
                reqParam.getUsername(), reqParam.getPassword(),
                reqParam.getVersionId(), reqParam.getTag());
