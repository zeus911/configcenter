...
import com.baidu.cc.web.action.VersionDelActionBase.DataResult;
...
public abstract class VersionDelActionBase<ReqParam, DataResult>
        extends
    ...
    /** request param. */
    @FromJSON(validationVisitor = VersionDelAction.class)
    protected VersionDelActionBase.ReqParam reqParam;
     ...
     * @return ReqParam
     */
    public VersionDelActionBase.ReqParam getReqParam() {
        if (reqParam == null) {
            reqParam = new VersionDelActionBase.ReqParam();
        }
        return reqParam;
    }
     ...
     *            ReqParam
     */
    public void setReqParam(VersionDelActionBase.ReqParam reqParam) {
    ...
    public void setAsDataResult(Object v) {
        if (v instanceof VersionDelActionBase.DataResult) {
            setData((VersionDelActionBase.DataResult) v);
        }
        setEJsonDataResult(v);
    }

    /** return data object. */
    protected VersionDelActionBase.DataResult data;
     ...
     * @return DataResult
     */
    public VersionDelActionBase.DataResult getData() {
        if (data == null) {
            data = new VersionDelActionBase.DataResult();
        }
        return data;
    }
     ...
     *            DataResult
     */
    protected void setData(VersionDelActionBase.DataResult data) {
        this.data = data;
    }
    ...
    protected Object getValidationTarget(Object target) {
        VersionDelAction action = new VersionDelAction();
        action.setReqParam((VersionDelActionBase.ReqParam) target);
        return action;
    }
