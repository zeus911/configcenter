...
import com.baidu.cc.web.action.VersionDelActionBase.ReqParam;
 ...
 * @author BJF
 */
public class VersionDelAction extends
        VersionDelActionBase<ReqParam, DataResult> {
    ...
    protected DataResult doExecuteService(ReqParam reqParam) {
        ...
        ids.add(versionId);
        versionService.deleteVersionCascadeByIds(ids);
        return null;
    }
