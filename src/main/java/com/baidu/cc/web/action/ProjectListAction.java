...
import com.baidu.cc.web.action.ProjectListActionBase.DataResult;
import com.baidu.cc.web.action.ProjectListActionBase.ReqParam;
 ...
 * @author BJF
 */
public class ProjectListAction extends
        ProjectListActionBase<ReqParam, DataResult> {
    ...
    protected DataResult doExecuteService(ReqParam reqParam) {
        ...
        List<Long> projectIds = accessSettingService.findRefIdsByUserIdAndType(
                NumberUtils.toLong(uid), SysUtils.ACCESS_SETTING_TYPE_PROJECT);

        DataResult dataResult = new DataResult();
        List<Project> projectList = projectService.findByIds(projectIds);

        dataResult.setProjectList(projectList);
        return dataResult;
    }
