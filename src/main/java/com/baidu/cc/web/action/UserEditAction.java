...
import com.baidu.cc.web.action.UserEditActionBase.DataResult;
import com.baidu.cc.web.action.UserEditActionBase.ReqParam;
 ...
 * @author BJF
 */
public class UserEditAction extends UserEditActionBase<ReqParam, DataResult> {
    ...
    protected DataResult doExecuteService(ReqParam reqParam) {
        if (reqParam.getUserId() != null) {
            getData().setUser(userService.findById(reqParam.getUserId()));
        }
        return getData();
    }
